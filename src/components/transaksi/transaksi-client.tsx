	...
	return (
		<div className="space-y-6">
				...
				<div className="grid grid-cols-3 gap-3">
					<Card className="bg-blue-50 border-blue-200">
						<CardContent className="p-4 text-center">
							...
							<p className="text-blue-600 font-bold text-lg">{formatCurrency(data.currentBalance)}</p>
						</CardContent>
					</Card>
			...
			<div className="flex items-center gap-3 flex-wrap">
				...
				<p className="text-gray-600 text-sm">{pagination ? `${pagination.total} transaksi` : ""}</p>
					...
					<Table>
						<TableHeader>
							<TableRow className="border-gray-200 hover:bg-transparent">
								...
								<TableHead className="text-gray-600">Hari</TableHead>
								...
								<TableHead className="text-gray-600 text-center">Hadir</TableHead>
							...
							{isLoading ? (
								...
								transactions.map((t) => (
									<TableRow key={t.id} className="border-gray-200 hover:bg-gray-50">
										...
										<TableCell className="text-gray-600 text-sm">{t.day}</TableCell>
										<TableCell>
											<Badge
												variant="outline"
												className={
